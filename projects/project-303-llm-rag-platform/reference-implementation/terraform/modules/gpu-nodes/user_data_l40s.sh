...
# Set GPU power limit for L40S (300W typical)
nvidia-smi -pl 300
...
/etc/eks/bootstrap.sh $CLUSTER_NAME \
  ...
  --kubelet-extra-args '--node-labels=nvidia.com/gpu=true,gpu-type=l40s,workload-type=llm-inference,spot-instance=true'
